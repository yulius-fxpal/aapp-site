...
export default class Adopt extends Component {
  ...
  render() {
    ...
    const title = 'Adopt a Polling Place';
    return (
      <>
        <Head>
          <title>{title}</title>
              ...
              <div className='flex flex-col w-full text-center'>
                <div className='mt-10'>
                  ...
                  <div className='md:flex md:items-center mb-6'>
                    <div className='md:w-1/4' />
                    <select
                      aria-label='Pick a County in the State'
                      className='md:w-1/2 bg-white hover:bg-blue-700 hover:text-white focus:outline-none focus:shadow-outline text-black py-2 px-4 w-1/3 rounded-full'
                    >
                      {countyList}
                    </select>
                  ...
                  <div className='md:flex md:items-center mb-6'>
                    ...
                    <input
                      ...
                      className='md:w-1/2 appearance-none bg-white block border border-gray-300 focus:outline-none focus:outline-none focus:shadow-outline focus:shadow-outline hover:bg-blue-700 hover:text-white leading-normal px-4 py-2 rounded-full rounded-lg text-black w-1/3 '
                      type='email'
                  ...
                  <div className='text-white absolute p-10 text-center'>
                    <div className='md:flex md:items-center mb-6'>
                      <div className='md:w-1/4' />
                      <label className='w-1/2 block font-bold' htmlFor='promise'>
