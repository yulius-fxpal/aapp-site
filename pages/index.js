        ...
        <div className='h-screen bg-gradient-to-b from-white via-grey-500 to-black-500 opacity-60'>
          <div class='container mx-auto h-screen relative'>
            ...
            <div className='text-white absolute bottom-0 p-10 text-center'>
              Voting is our patriotic duty and our right. Many Americans will be asked to do too much in order to
              exercise that right. By adopting a polling place, you're promising to support your neighbors as they in
              the next election. You're pledging to bring a few boxes of Pizza, lawn chairs or maybe some games to help
              them deal with the unfairly long lines in some communities.
            </div>
          </div>
        </div>
      </div>
